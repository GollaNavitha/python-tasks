...
--SELECT UPPER('data engineering') FROM hr.employees;

 --SELECT LOWER('DATA ENGINEERING') FROM dual;
--SELECT LOWER('DATA ENGINEERING') FROM hr.employees;

--SELECT INITCAP('oracle database administrator') FROM dual;
--SELECT INITCAP('oracle database administrator') FROM hr.employees;

--SELECT LENGTH('machine learning') FROM dual;
--SELECT LENGTH('machine learning') FROM hr.employees;

 --SELECT SUBSTR('artificial intelligence',1,10) FROM dual;
--SELECT SUBSTR('artificial intelligence',1,10) FROM hr.employees;

 --SELECT CONCAT('Oracle ','SQL') FROM dual;
--SELECT CONCAT('First_name ','SQL') FROM hr.employees;

--SELECT REPLACE('hello python','python','oracle') FROM dual;
--SELECT REPLACE('hello python','python','oracle') FROM hr.employees;

--SELECT TRIM('    database    ') FROM dual;
--SELECT TRIM('    database    ') FROM hr.employees;

--SELECT LTRIM('00000500','0') FROM dual;
--SELECT LTRIM('00000577','1') FROM hr.employees;

--SELECT RTRIM('500000','0') FROM dual;
--SELECT RTRIM('500000','4') FROM hr.employees;

--SELECT LPAD('500',8,'0') FROM dual;
--SELECT LPAD('500',8,'0') FROM hr.employees;

 --SELECT RPAD('SQL',10,'.') FROM dual;
--SELECT RPAD('SQL',10,'.') FROM hr.employees;

-- SELECT ASCII('A') FROM dual;
--SELECT ASCII('A') FROM hr.employees;

-- SELECT CHR(65) FROM dual;
-- SELECT CHR(65) FROM hr.employees;
